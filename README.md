...
| :--- | :--- | :--- | :--- |
| **Week 1** | SQL Əsaslardan Qabaqcıl Səviyyəyə | SQLite, SQL (JOINs, CTE, Window Functions) | [🔗 Readme-yə keçid](./Week_1_SQL_/README.md) |
...
| Həftə | Mövzu | İstifadə Olunan Alətlər | Ətraflı Hesabat |
| :--- | :--- | :--- | :--- |
