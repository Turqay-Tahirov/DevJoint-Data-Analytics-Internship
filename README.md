...
1. **Sual 1: Almaniyadakı ilk 5 müştəri kimlərdir?**
   ...
   * **Məntiq:** Almaniyada yerləşən müştəriləri əlifba sırası ilə sıralayıb ilk 5 nəticəni gətirir.
   * **Nəticə skrinşotu:**
     ![Query 1 Result](./Week_1_SQL/Checkpoint_1/images/query_1_result.png)
...
2. **Sual 2: Londonda yaşayan rəhbər şəxslər (Owner və ya Manager) kimlərdir?**
   ...
   * **Nəticə skrinşotu:**
     ![Query 2 Result](./Week_1_SQL/Checkpoint_1/images/query_2_result.png)
...
3. **Sual 3: ABŞ daxilində karqo pulu 150$-dan çox olan ilk 10 baha sifariş hansıdır?**
   ...
   * **Nəticə skrinşotu:**
     ![Query 3 Result](./Week_1_SQL/Checkpoint_1/images/query_3_result.png)
...
4. **Sual 4: Müştəriyə hələ göndərilməmiş ən təcili ilk 5 sifariş hansıdır?**
   ...
   * **Nəticə skrinşotu:**
     ![Query 4 Result](./Week_1_SQL/Checkpoint_1/images/query_4_result.png)
...
5. **Sual 5: Fransaya göndərilən və dəyəri 1000$-dan baha olan ilk 5 satış hansıdır?**
   ...
   * **Nəticə skrinşotu:**
     ![Query 5 Result](./Week_1_SQL/Checkpoint_1/images/query_5_result.png)
